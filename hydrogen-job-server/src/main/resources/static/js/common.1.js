$(function () {
  ...
  class CookieValue {
    ...
    get() {
      return $.cookie(this._name);
    }

    set(value, expiry) {
      $.cookie(this._name, value, {expires: expiry, path: "/;SameSite=Lax"});
      if (this._onUpdate) {
  ...
  const updatePwdModalValidate = $("#updatePwdModal .form").validate({
    errorElement: 'span',
